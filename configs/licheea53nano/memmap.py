...
class MemoryMap:
    ...
    # =================
    ION_SIZE = 0 * SIZE_1M # modify from => 63 * SIZE_1M
    H26X_BITSTREAM_SIZE = 0 * SIZE_1M # modify from => 2 * SIZE_1M
    H26X_ENC_BUFF_SIZE = 0
    ISP_MEM_BASE_SIZE = 0 * SIZE_1M # modify from => 20 * SIZE_1M
    ...
    BOOTLOGO_SIZE = 8000 * SIZE_1K # modify from => 5632 * SIZE_1K
